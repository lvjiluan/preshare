            ...
            <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                <div class="widget am-cf">
                    ...
                    <div class="widget-body  am-fr">
                            ...
                            <div class="am-form-group">
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <a type="button" class="am-btn am-btn-default am-btn-success" href="<?php echo U('GoodsCategory/editGoodsCategory');?>"><span class="am-icon-plus"></span> 新增</a>
                        ...
                        <form action="/index.php/Admin/GoodsCategory/listGoodsCategory" method="get">
                            <div class="am-u-sm-12 am-u-md-12 am-u-lg-4">
                                <div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
                                    ...
                                    <span class="am-input-group-btn">
                                        ...
                                        <a class="am-btn  am-btn-default am-btn-danger tpl-table-list-field am-icon-refresh" type="button" href="/index.php/Admin/GoodsCategory/listGoodsCategory"></a>
                                    </span>
                                </div>
                            </div>
                            ...
                            <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black " id="example-r">
                                ...
                                <tbody>
                                    <?php if(is_array($catlist)): foreach($catlist as $key=>$v): ?><tr class="gradeX">
                                            <!--<td><?php if($v['article_cat_id'] != 1 && $v['article_cat_id'] != 2): ?><input class="ids" type="checkbox" name="chkbId" value="<?php echo ($v['article_cat_id']); ?>"><?php endif; ?></td>-->
                                            <td><?php echo ($v['id']); ?></td>
                                            ...
                                            <td class="f-14">
                                                <div class="tpl-table-black-operation">
                                                    <a href="<?php echo U('GoodsCategory/editGoodsCategory',array('id'=>$v['id']));?>">
                                                        <i class="am-icon-pencil"></i> 编辑
                                                    </a>
                                                    <!--<?php if($v['article_cat_id'] != 1 && $v['article_cat_id'] != 2): ?>-->
