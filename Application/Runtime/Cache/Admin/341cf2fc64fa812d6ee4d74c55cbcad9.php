                    ...
                    <div class="widget-body  am-fr">
                            ...
                            <div class="am-form-group">
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <a type="button" class="am-btn am-btn-default am-btn-success" href="<?php echo U('Goods/editGoods');?>"><span class="am-icon-plus"></span> 新增</a>
                                        <button type="button" class="am-btn am-btn-default am-btn-danger" onclick="javascript:recycle('chkbId', '确认删除?! 删除后无法恢复!', true)">
                                            <span class="am-icon-trash-o"></span> 批量删除
                                        </button>
                                        <a type="button" class="am-btn am-btn-default am-btn-success" href="<?php echo U('Goods/editPrice');?>"><span class="am-icon-plus"></span> 批量修改</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <form action="/index.php/Admin/Goods/listGoods" method="get">
                            <div class="am-u-sm-12 am-u-md-6 am-u-lg-3">
                                <div class="am-form-group tpl-table-list-select">
                                    <select data-am-selected="{searchBox: 1}" name="goods_cat_id" id="goods_cat_id">
                                        <option value="-1">请选择品名</option>
                                        <?php if(is_array($spec["cat"])): foreach($spec["cat"] as $key=>$v): ?><option value="<?php echo ($v['id']); ?>"><?php echo ($v['cat_name']); ?></option><?php endforeach; endif; ?>
                                    </select>
                            ...
                            <div class="am-u-sm-12 am-u-md-12 am-u-lg-3">
                                <div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
                                    ...
                                    <span class="am-input-group-btn">
                                        ...
                                        <a class="am-btn  am-btn-default am-btn-danger tpl-table-list-field am-icon-refresh" type="button" href="/index.php/Admin/Goods/listGoods"></a>
                                    </span>
                                </div>
                            </div>
                            <input name="p" value="1" type="hidden"/>
                        </form>
                        <!--<form action="<?php echo U('Admin/Goods/editPrice');?>" method="get">-->
                            <!--<div class="">-->
                                    <!--<input type="text"  class=""  value="" placeholder="请输入要增加的数值" name="edit_price"/>-->
                        ...
                        <div class="am-u-sm-12">
                            <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black " id="example-r">
                                ...
                                <tbody>
                                    <?php if(is_array($goodslist)): foreach($goodslist as $key=>$v): ?><tr class="gradeX">
                                            <td><input class="ids" type="checkbox" name="chkbId" value="<?php echo ($v['goods_id']); ?>"></td>
                                            ...
                                            <td class="center">
                                                ...
                                                <?php echo ($v['width']); ?>* <?php echo ($v['height']); ?>
                                           </td>
                                            <td class="center">
                                                 <?php echo ($v['store_count']); ?>
                                            </td>
                                            <td class="center">
                                                <?php echo fen_to_yuan($v['price']);?>
                                            </td>
                                            <td class="center">
                                            ...
                                            <td class="f-14">
                                                <div class="tpl-table-black-operation">
                                                    <a href="<?php echo U('Goods/editGoods',array('goods_id'=>$v['goods_id']));?>">
                                                        <i class="am-icon-pencil"></i> 编辑
                                                    </a>

                                                    <a href="javascript:void(0)" onclick="javascript:recycle(<?php echo ($v['goods_id']); ?>, '确认删除?!此步骤无法恢复!', true)" class="tpl-table-black-operation-del">
                            ...
                            <?php if(empty($goodslist)): ?><h4>aOh! 没有相关内容!</h4><?php endif; ?>
                        </div>
