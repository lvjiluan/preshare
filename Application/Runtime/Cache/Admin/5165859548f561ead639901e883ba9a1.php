            ...
            <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                <div class="widget am-cf">
                    ...
                    <div class="widget-body  am-fr">
                        ...
                        <!--<form action="/index.php/Admin/OrderCustomize/index" method="get">-->
                            <!--<div class="am-u-sm-12 am-u-md-12 am-u-lg-3">-->
                                <!--<div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">-->
                                    ...
                                    <!--<span class="am-input-group-btn">-->
                                        ...
                                        <!--<a class="am-btn  am-btn-default am-btn-danger tpl-table-list-field am-icon-refresh" type="button" href="/index.php/Admin/OrderCustomize/index"></a>-->
                                    <!--</span>-->
                                <!--</div>-->
                            <!--</div>-->
    ...
    <script type="text/javascript">
        function examine(order_id,order_status){
            $.ajax({
                ...
                url:"<?php echo U('Admin/OrderCustomize/examine');?>",
