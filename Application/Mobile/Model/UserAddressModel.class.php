...
class UserAddressModel extends Model
{
    ...
    protected $updateFields = array('address_id','consignee','address','province','city','district','mobile','zipcode','is_default','user_id');
    protected $selectFields = array('address_id','consignee','address','province','city','district','mobile','zipcode','is_default','user_id');
